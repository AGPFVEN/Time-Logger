...
pub trait Storage {
    fn init(config_path: &str) -> Self where Self:Sized;
    ...
    fn start_timer_on_task(&self, project_name: &str, task_name: &str) -> Result<(), diesel::result::Error>;
    fn end_timer_on_task(&self, entry_to_close: &i32, description_input: &str) -> Result<(), diesel::result::Error>;
}
